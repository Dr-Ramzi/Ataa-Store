...
class DeductionOrderX extends OrderX {
  ...
  factory DeductionOrderX.fromJson(Map<String, dynamic> json) {
    Map<String, Object?> deductionJson = Map<String, Object?>.from(json[NameX.recurringDonation]);
    return ModelUtilX.checkFromJson(
      json,
        ...
        nextSubscriptionDiscountDate: json[NameX.nextSubscriptionDiscountDate].toDateTimeX,
